...
#ifndef BLE_REMOTE_CONFIG_H
#define BLE_REMOTE_CONFIG_H
...
#define PMU_CFG_VBAT                    PMU_CFG_VBAT_3V         //VBAT供电类型选择
...
#define SYS_PWROFF_TIME                 60                      //无连接自动关机时间(秒), 0为不自动关机
...
#define BSP_KEYSCAN_EN                  0xff                    //keyscan按鍵使能, High~Low：PB9~PB5, PB2~PB0, 0为不使能
#define BSP_TSENSOR_EN                  0                       //内置温度检测使能
#define BSP_IR_TX_EN                    GPIO_PB4                //红外发射功能
#define BSP_IR_RX_EN                    GPIO_NULL               //红外接收功能
