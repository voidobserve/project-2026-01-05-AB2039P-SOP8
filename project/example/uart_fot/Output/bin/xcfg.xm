...
config(BYTE, "VBG电压档位", "配置VBG电压档位，0到31", VBG_LEVEL, 0, 31, 15);
...
config(LISTVAL, "LED灯IO选择", "LED灯IO选择", LED_IO_SEL, BIT, 4, 0, 11, ("PB0", 0), ("PB1", 1), ("PB2", 2), ("PB3", 3), ("PB4", 4), ("PB5", 5),  ("PB6", 6),("PB7", 7),("PB8", 8),("PB9", 9),("PB10", 10));
