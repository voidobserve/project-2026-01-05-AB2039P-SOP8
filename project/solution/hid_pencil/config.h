...
#ifndef HID_PENCIL_CONFIG_H
#define HID_PENCIL_CONFIG_H
 ...
 * Module    : 系统功能选择配置
 *****************************************************************************/
#define SYS_CLK_SEL                     SYS_48M                 //选择系统时钟(!!!开启PWM后仅可用24/48M!!!)
...
#define SYS_SLEEP_EN                    1                       //系统休眠使能(配合震动开关使用)
...
#define BSP_TSENSOR_EN                  0                       //高温频偏校准
#define BSP_GSENSOR_DETECT_EN           0                       //震动开关(关闭时休眠自动关闭)
