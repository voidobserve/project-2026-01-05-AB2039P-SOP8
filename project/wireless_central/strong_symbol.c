...
STRONG uint8_t cfg_bt_work_mode         = MODE_WIRELESS;
...
STRONG uint8_t cfg_bt_rf_def_txpwr;
...
uint8_t private_freq_bands_hook(void)
{
    return PRIVATE_FREQ_BANDS_SEL;
}

uint32_t private_access_code_hook(void)
{
    return PRIVATE_ACCESS_CODE;
}
