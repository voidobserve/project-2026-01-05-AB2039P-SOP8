...
#define GPIO_SUPPORT_STRONG_CURRENT_64MA(drv, gpiox, pin_idx)           ((GPIOPB4_DRV_I_64MA & drv) && (GPIOB_REG == gpiox) && (GPIO_PIN_4 == BIT(pin_idx-1)))
#define GPIO_SUPPORT_HIGH_VOLTAGE_PB0(drv, gpiox, pin_idx)              ((GPIOPB0_DRV_U_VBAT & drv) && (GPIOB_REG == gpiox) && (GPIO_PIN_0 == BIT(pin_idx-1)))
#define GPIO_SUPPORT_HIGH_VOLTAGE_PB1(drv, gpiox, pin_idx)              ((GPIOPB1_DRV_U_VBAT & drv) && (GPIOB_REG == gpiox) && (GPIO_PIN_1 == BIT(pin_idx-1)))
