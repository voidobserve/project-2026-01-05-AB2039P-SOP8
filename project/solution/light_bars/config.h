...
#ifndef LIGHT_BARS_CONFIG_H
#define LIGHT_BARS_CONFIG_H
...
#define FUNC_LE_FCC_EN                  0   //是否打开蓝牙FCC测试功能，需通过切换模式进入才能生效(func_cb.sta = FUNC_LE_FCC), 使用单线串口通信, PB3, 1500000
#define FUNC_LE_BQB_RF_EN               0   //是否打开蓝牙BQB测试功能, 需通过切换模式进入才能生效(func_cb.sta = FUNC_LE_BQB_RF), 使用串口通信, RX:PA0, TX:PA1 ,9600
...
#define PROD_TEST_MIC_EN                0            //MIC测试（当无按键测试项时，连上测试盒会自动进入语音测试）

/*****************************************************************************
 * Module    : 降噪算法配置
 *****************************************************************************/
#define NOTCH_IIR_EN                   1             //陷波器
