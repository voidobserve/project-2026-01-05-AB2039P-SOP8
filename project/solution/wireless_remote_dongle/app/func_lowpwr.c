...
#if SYS_PWROFF_TIME
    soft_timer_handle_t soft_timer_handle_pwroff;
    soft_timer_mem_t soft_timer_mem_pwroff;
    soft_timer_mem_extend(&soft_timer_mem_pwroff, sizeof(soft_timer_mem_pwroff));
    soft_timer_acquire(&soft_timer_handle_pwroff, sys_cb.pwroff_delay * 100, 0, soft_timer_pwroff_callback);
    soft_timer_start(soft_timer_handle_pwroff);
    printf("pwroff after sleep %dms\n", sys_cb.pwroff_delay * 100);
#endif
...
#if SYS_PWROFF_TIME
    soft_timer_mem_free(&soft_timer_mem_pwroff, sizeof(soft_timer_mem_pwroff));
#endif
